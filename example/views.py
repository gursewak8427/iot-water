...
def index(request) :
    ...
    #................load ANN model.........................
    json_file = open("https://ishpreet-sir-iot-backend.herokuapp.com/content/model2.json", 'r')
    loaded_model_json = json_file.read() 
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)
    # load weights into new model
    loaded_model.load_weights("https://ishpreet-sir-iot-backend.herokuapp.com/content/model2.h5")
    ...
    sand_infodb=pd.read_excel("https://ishpreet-sir-iot-backend.herokuapp.com//content/sand_info.xlsx",sheet_name="Sand_info")
    crop_infodb=pd.read_excel("https://ishpreet-sir-iot-backend.herokuapp.com//content/sand_info.xlsx",sheet_name="Crop_Coff")
    root_db=pd.read_excel("https://ishpreet-sir-iot-backend.herokuapp.com//content/sand_info.xlsx",sheet_name="Root Depth")
